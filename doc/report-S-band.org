...
#+NAME: fig:dir:ref:2_32ghz
#+CAPTION: Нормированный на 0 коэффициент направленного действия антенны на 2.32 ГГц, расчет
[[file:images/directivity_reference_2_32ghz.png]]

#+NAME: fig:dir:meas:2_32ghz
#+CAPTION: Нормированный на 0 коэффициент направленного действия антенны на 2.32 ГГц, измерение
[[file:images/directivity_measured_2_32ghz.png]]

#+NAME: fig:dir:ref:2_42ghz
#+CAPTION: Нормированный на 0 коэффициент направленного действия антенны на 2.42 ГГц, расчет
[[file:images/directivity_reference_2_32ghz.png]]

#+NAME: fig:dir:meas:2_42ghz
#+CAPTION: Нормированный на 0 коэффициент направленного действия антенны на 2.42 ГГц, измерение
[[file:images/directivity_measured_2_32ghz.png]]

#+NAME: table:dir:results
#+CAPTION: Ширины ДН антенн по уровню -3 дБ относительно максимума
| Тип                    | Значение    |
|------------------------+-------------|
| ДН 2.32 ГГц, расчет    | 94..99 град |
| ДН 2.32 ГГц, измерение | 100±5 град  |
| ДН 2.42 ГГц, расчет    | 94..97 град |
| ДН 2.42 ГГц, измерение | 98±3 град   |
...
#+NAME: table:gain:results
#+CAPTION: Результаты измерения коэффициента усиления антенн
| Тип антенны   | Частота Fc | Расстояние L | Коэффициент Фрииса | Cable Loss | Gain (измеренный) | Gain (расчет) |
|---------------+------------+--------------+--------------------+------------+-------------------+---------------|
| патч 2.32 ГГц | 2.284 ГГц  | 150 см       | -43.1 дБ           | 5.1 дБ     | 7.1 дБи           | 5.7 дБи       |
| патч 2.42 ГГц | 2.362 ГГц  | 150 см       | -43.4 дБ           | 5.6 дБ     | 6.6 дБи           | 5.6 дБи       |
